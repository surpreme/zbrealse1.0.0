                ...
                .execute(new AbsCallback<BaseData<NewsBean>>() {
                    ...
                    public BaseData<NewsBean> convertResponse(okhttp3.Response response) throws Throwable {
                        ...
                        if (baseData.getDatas().getError() != null) {
                            ...
                            NewsBean firstNewUserBean = BeanConvertor.convertBean(jsonObject.toString(), NewsBean.class);
                    ...
                    @Override
                    public void onStart(Request<BaseData<NewsBean>, ? extends Request> request) {
                        LogUtils.d("onStart");
