...
public class GetInformationBookActivity extends BaseActivity<GetInformationBookContract.View, GetInformationBookPresenter> implements GetInformationBookContract.View {
    ...
    protected void initDatas() {
        mPresenter.getBookInforMation(getIntent().getStringExtra("chriendtype"), initParams());
    ...
    private HttpParams initParams() {
        ...
        httpParams.put("id", isStringEmpty(getIntent().getStringExtra("id")) ? "" : getIntent().getStringExtra("id"));
        return httpParams;
    }
    ...
    public void onGetBookInforMationSuccess(Object msg) {
        ...
        mobileTv.setText(infoBean.getInfo().getMobile());
        // case "1":
        ...
        if (!infoBean.getInfo().getOrder_status().equals("3")) {
            bottomBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(HekpStartActivity.class);
