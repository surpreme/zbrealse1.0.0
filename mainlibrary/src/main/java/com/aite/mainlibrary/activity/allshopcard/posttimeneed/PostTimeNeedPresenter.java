...
public class PostTimeNeedPresenter extends BasePresenterImpl<PostTimeNeedContract.View> implements PostTimeNeedContract.Presenter {

    @Override
    public void getPostService(HttpParams httpParams) {
        OkGo.<BaseData<TwoSuccessCodeBean>>post(AppConstant.POSTTIMEBANKSERVICEURL)
                    ...
                    public BaseData<TwoSuccessCodeBean> convertResponse(okhttp3.Response response) throws Throwable {
                        ...
                        if (baseData.getDatas().getError() != null) {
                            ...
                            ((Activity) mView.getContext()).runOnUiThread(()
                                    -> mView.onPostServiceSuccess(successCodeBean));
                        }
    ...
    @Override
    public void getChoiceServiceType() {
        OkGo.<BaseData<TypeBean>>post(AppConstant.GETBANKSERVICETYPEURL)
                .tag(mView.getContext())
...
//                            TypeBean typeBean = BeanConvertor.convertBean(object.toString(), TypeBean.class);
                            ((Activity) mView.getContext()).runOnUiThread(()
                                    -> mView.onChoiceServiceTypeSuccess(typeBean));
                        }
