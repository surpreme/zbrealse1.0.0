...
public class PostHelpDoctorPresenter extends BasePresenterImpl<PostHelpDoctorContract.View> implements PostHelpDoctorContract.Presenter {

    @Override
    public void postInformation(HttpParams httpParams) {
        OkGo.<BaseData<TwoSuccessCodeBean>>post(AppConstant.POSTHELPDOCTORNEEDURL)
                    ...
                    public BaseData<TwoSuccessCodeBean> convertResponse(okhttp3.Response response) throws Throwable {
                        ...
                        if (baseData.getDatas().getError() != null) {
                            ...
                            ((Activity) mView.getContext()).runOnUiThread(()
                                    -> mView.onPostSuccess(successCodeBean));
                        }
    ...
    public void getTypeService() {
        OkGo.<BaseData<TypeBean>>get(AppConstant.TYPECHIOCEHELPDOCTORNEEDURL)
                .tag(mView.getContext())
