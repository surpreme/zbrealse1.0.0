...
public class BookHelpDoctorInformationPresenter extends BasePresenterImpl<BookHelpDoctorInformationContract.View> implements BookHelpDoctorInformationContract.Presenter{
    ...
    public void StartService(HttpParams httpParams) {
        OkGo.<BaseData<HelpDoctorInformationBean>>post(AppConstant.STARTHELPDOCTORNEEDURL)
                .tag(mView.getContext())
                .params(httpParams)
                .execute(new AbsCallback<BaseData<HelpDoctorInformationBean>>() {
                    @Override
