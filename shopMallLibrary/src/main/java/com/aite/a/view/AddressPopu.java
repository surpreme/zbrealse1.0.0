 ...
 * 地址选择
 */
public class AddressPopu extends PopupWindow implements View.OnClickListener {
    private Activity mActivity = null;
    private ListView lv_sms;
    private LinearLayout rl_c;
    private RelativeLayout rl_1;
    private SmsAdapter smsAdapter;
    private List<ChooseAddressInfop> data;

    public AddressPopu(Activity activity, List<ChooseAddressInfop> data, int margins, int margins2) {
        mActivity = activity;
        this.data = data;
...
//        h.sendEmptyMessageDelayed(0, 300);
    ...
    private class SmsAdapter extends BaseAdapter {
        ...
        public SmsAdapter(List<ChooseAddressInfop> data) {
            this.data = data;
        }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            hodler.tv_address.setText(data.get(position).area_name);
