...
public class PullToRefreshLayout extends RelativeLayout {
	...
	public void refreshFinish(int refreshResult) {
		...
		case SUCCEED:
			...
			refreshStateTextView.setText(mContext.getString(R.string.near_reminder20));
		...
		default:
			// 刷新失败
			refreshStateImageView.setVisibility(View.VISIBLE);
			refreshStateTextView.setText(mContext.getString(R.string.near_reminder21));
			refreshStateImageView
	...
	public void loadmoreFinish(int refreshResult) {
		...
		case SUCCEED:
			...
			loadStateTextView.setText(mContext.getString(R.string.near_reminder22));
		...
		default:
			// 加载失败
			loadStateImageView.setVisibility(View.VISIBLE);
			loadStateTextView.setText(mContext.getString(R.string.near_reminder23));
	...
	private void changeState(int to) {
		...
		case INIT:
			...
			refreshStateTextView.setText(mContext.getString(R.string.xlistview_header_hint_normal));
			pullView.clearAnimation();
			pullView.setVisibility(View.VISIBLE);
			// 上拉布局初始状态
			loadStateImageView.setVisibility(View.GONE);
			loadStateTextView.setText(mContext.getString(R.string.pull_to_refresh_footer_pull_label));
			pullUpView.clearAnimation();
			pullUpView.setVisibility(View.VISIBLE);
			break;
		case RELEASE_TO_REFRESH:
			// 释放刷新状态
			refreshStateTextView.setText(mContext.getString(R.string.xlistview_header_hint_ready));
		...
		case REFRESHING:
			...
			refreshStateTextView.setText(mContext.getString(R.string.pull_to_refresh_refreshing_label));
			break;
		case RELEASE_TO_LOAD:
			// 释放加载状态
			loadStateTextView.setText(mContext.getString(R.string.xlistview_footer_hint_ready));
