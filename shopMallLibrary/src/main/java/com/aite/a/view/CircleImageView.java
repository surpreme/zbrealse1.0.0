...
public class CircleImageView extends ImageView {
	...
	public CircleImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
		...
		mBorderColor = a.getColor(R.styleable.CircleImageView_mcolor, mBorderColor);
		final int defalut = (int) (2 * paramContext.getResources().getDisplayMetrics().density + 0.5f);
		mBorderWidth = a.getDimensionPixelOffset(R.styleable.CircleImageView_width, defalut);
		a.recycle();
	}
