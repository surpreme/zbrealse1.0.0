    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && APPSingleton.getContext().getApplicationContext().getExternalCacheDir() != null)
                defaultDir = APPSingleton.getContext().getApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = APPSingleton.getContext().getApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
