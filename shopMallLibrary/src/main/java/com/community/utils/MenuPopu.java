 ...
 * 菜单选择
 */
public class MenuPopu extends PopupWindow implements View.OnClickListener {
    private Activity mActivity = null;
    private SmsAdapter smsAdapter;
    private ListView lv_menu;
    private List<String> data;

    public MenuPopu(Activity activity, List<String> data) {
        mActivity = activity;
        this.data = data;
...
//		setHeight((int) (height * 0.3));
        ...
        View view = View.inflate(mActivity, R.layout.popupwindow_menu, null);
