...
public class Dynamic2Adapter extends BaseAdapter {
    ...
    public Dynamic2Adapter(Context mcontext, List<CircleoffriendsInfo.list> data, Handler handler, Activity mActivity) {
     ...
     * @param data
     */
    public void refreshData(List<CircleoffriendsInfo.list> data) {
        if (data == null) return;
        this.data = data;
     ...
     * @param data
     */
    public void addData(List<CircleoffriendsInfo.list> data) {
        if (data == null) return;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final CircleoffriendsInfo.list theme_list = data.get(position);
...
//                showpopu(holder.iv_msg, theme_list.member_id);
            }
        });
...
//                    }
    ...
    class CommentAdaapter extends BaseAdapter {
        ...
        public CommentAdaapter(List<CircleoffriendsInfo.list.reply_info> reply_info) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                new CommentAdaapter.CommentHolder(convertView);
            }
            CommentAdaapter.CommentHolder holder = (CommentAdaapter.CommentHolder) convertView.getTag();
            CircleoffriendsInfo.list.reply_info reply_info = this.reply_info.get(position);
