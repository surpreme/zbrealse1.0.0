 ...
 */
public class Article4Adapter extends BaseAdapter {
    private Context mcontext;
    private List<ForumListInfo.list> data;

    public Article4Adapter(Context mcontext, List<ForumListInfo.list> data) {
     ...
     * @param data
     */
    public void refreshData(List<ForumListInfo.list> data){
        if (data==null)return;
        this.data=data;
     ...
     * @param data
     */
    public void addData(List<ForumListInfo.list> data){
        if (data==null)return;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ForumListInfo.list cms_article_list = data.get(position+1);
