...
public class ArticleAdapter extends BaseAdapter {
    ...
    private List<FindHomeInfo.cms_article_list> data;

    public ArticleAdapter(Context mcontext, List<FindHomeInfo.cms_article_list> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final FindHomeInfo.cms_article_list cms_article_list = data.get(position+1);
