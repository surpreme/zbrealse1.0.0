...
public class Article3Adapter extends BaseAdapter {
    private Context mcontext;
    private List<ForumSectionInfo.cms_article_list> data;

    public Article3Adapter(Context mcontext, List<ForumSectionInfo.cms_article_list> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ForumSectionInfo.cms_article_list cms_article_list = data.get(position+1);
