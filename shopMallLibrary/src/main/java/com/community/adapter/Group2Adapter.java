...
public class Group2Adapter extends BaseAdapter {
    ...
    public Group2Adapter(Context mcontext, List<PostGroupInfo.list> data) {
     ...
     * @param data
     */
    public void refreshData(List<PostGroupInfo.list> data) {
        if (data == null) return;
        this.data = data;
     ...
     * @param data
     */
    public void addData(List<PostGroupInfo.list> data) {
        if (data == null) return;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final PostGroupInfo.list circle_list = data.get(position);
...
//                mcontext.startActivity(intent3);
    ...
    class MemberAdapter extends BaseAdapter {
        ...
        public MemberAdapter(List<PostGroupInfo.list.member_list> member_list) {
