package com.aite.aitezhongbao.View;
...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    private int TextSelectedColor = Color.parseColor("#75c5f0");
    private int TextEmptyColor = Color.parseColor("#75c5f0");
    //顶部的tab集合
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = Color.parseColor("#75c5f0");
    //列表icon资源
    ...
    private class Line extends LinearLayout {
        ...
        private int SelectedColor = Color.parseColor("#75c5f0");
    ...
    private class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder viewHolder =
                    new MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_address, parent, false));
            return viewHolder;
        }
