package com.lzy.basemodule.logcat;
    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && BaseApp.getContext().getApplicationContext().getExternalCacheDir() != null)
                defaultDir = BaseApp.getContext().getApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = BaseApp.getContext().getApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
