...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager)  BaseApp.getContext().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static Uri saveBitmapToFile(Context context, String url, Bitmap bitmap, View container, boolean isShare){
        ...
        try {
            ...
            if (isCompress) {
               LogUtils.d(container+"保存成功n(*≧▽≦*)n");
            } else {
                LogUtils.d(container+"保存失败ヽ(≧Д≦)ノ");
            }
            fos.flush();
            fos.close();
        } catch (IOException e) {
