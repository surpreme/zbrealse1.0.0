...
public class PickerView extends View {
    ...
    public interface OnSelectIndexListener {
        void onSelect(View view, String selected, int index);
    }
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, android.R.color.darker_gray);
        mDarkColor = ContextCompat.getColor(mContext, android.R.color.darker_gray);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float maxTextSize = height / 7f;//mContext.getResources().getDimension(R.dimen.sp_14)
    ...
    private void keepScrolling() {
        if (Math.abs(mScrollDistance) < AUTO_SCROLL_SPEED) {
            ...
            if (mTimerTask != null) {
                ...
                if (onSelectIndexListener != null && mSelectedIndex < mDataList.size()) {
                    onSelectIndexListener.onSelect(this, mDataList.get(mSelectedIndex), mSelectedIndex);
                }
            }
